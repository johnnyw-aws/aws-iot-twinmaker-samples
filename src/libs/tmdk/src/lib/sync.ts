      ...
      try {
        ...
        if (parentEntityId != undefined && existingBody["parentEntityId"] !== parentEntityId) {
          if (parentEntityId == "") {
            ...
            parentEntityUpdate = {updateType: "UPDATE", parentEntityId: parentEntityId};
          }
        }
        await updateEntity(
          workspaceId,
