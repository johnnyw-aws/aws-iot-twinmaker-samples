...
export class CookieFactoryV2Stack extends cdk.Stack {
    constructor(scope: Construct, id: string, props?: cdk.StackProps) {
        ...
        // todo: figure out why everything except UserPool gets deleted during cdk destroy
        ...
        // todo: turn off all the Hosted UI configurations; note status is unavailable so this is low priority
