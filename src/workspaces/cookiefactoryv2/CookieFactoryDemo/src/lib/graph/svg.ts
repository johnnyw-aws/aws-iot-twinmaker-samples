...
export function createSvgString({
  ...
  switch (shape) {
    case 'diamond':
      return createDiamondSvgString({ backgroundColor, borderColor, borderWidth, size });
    case 'hexagon':
      return createHexagonSvgString({ backgroundColor, borderColor, borderWidth, size });
    case 'rectangle':
      return createRectangleSvgString({ backgroundColor, borderColor, borderWidth, size });
    default:
      return createEllipseSvgString({ backgroundColor, borderColor, borderWidth, size });
  }
}
